    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
         <li class="header">MAIN NAVIGATION</li>
          ...
          <li><a href="{{route('role.index')}}"><i class="fa fa-circle-o"></i> User Roles</a></li>

           <li><a href="{{route('permission.index')}}"><i class="fa fa-circle-o"></i> User Roles Permission</a></li>
